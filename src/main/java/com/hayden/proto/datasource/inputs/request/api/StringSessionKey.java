...
public interface StringSessionKey extends Prototyped<SessionKeyContractProto, String> {
    @Override
    default SessionKeyContractProto proto() {
        return new SessionKeyContractProto.PermitsValueContractProto(new ValueContractProto.PermittingString(new StringContractProto() {}));
    }
