...
import com.hayden.proto.prototyped.datasources.ai.modelserver.client.ModelServerRerankAiClient;
...
@NoArgsConstructor
@AllArgsConstructor
public class ModelServerRerankRequest implements WithRetryParams {

    ModelServerRerankAiClient.ModelServerRerankBody content;
    ...
    public ModelServerRerankRequest(ModelServerRerankAiClient.ModelServerRerankBody content) {
